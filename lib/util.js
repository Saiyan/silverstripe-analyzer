...
exports.getCellFromPlaceholder = function(sspage,placeholder){
    switch (placeholder) {
        case '%s':
        ...
        case '%da':
            return sspage ? sspage.hasDefaultAdmin() : "DefaultAdmin";
        case '%el':
            return sspage ? sspage.hasEmailLogging() : "EmailLogging";
        case '%et':
            return sspage ? sspage.getEnvironmentType() : "EnvironmentType";
        case '%m':
            return sspage ? sspage.getModules().join(', ') : "Modules";
        case '%cfgp':
